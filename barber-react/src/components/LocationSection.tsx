    ...
    <section className="py-24 bg-surface-container-low">
      <div className="container mx-auto px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-[400px] rounded-lg overflow-hidden border border-outline-variant/20 shadow-2xl bg-[#1a1b1b] bg-[url('https://lh3.googleusercontent.com/aida-public/AB6AXuDBhTzCYnUJerlNPmlMrGZAkvwjZ2eRNpaJzIGFHKc61ba82_bxf-v8zSyzodKJXkeTK6jN4YVtrqpNqTqi1-6U_z4i0P5lfoXtegtZFmq35aEX9sbOtPC5-purSiXMbxUZzKm_pts19wgJi1UBSAyq9YCETbZo4dRJLtKQcea4bMJUzwetR903gYlzyqx4dHxhRtrUDjBiAZNfI90MCNuku8Y02yEKCH2DTcZfStpiETweCRNebsV6D3EIZjlESW5PgDMYjDbyJoE')]">
